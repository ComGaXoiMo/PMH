...
function withSplashScreen(WrappedComponent) {
  return class extends Component {
    ...
    componentDidMount = async () => {
      try {
        let data = await abpUserConfigurationService.getAll();
        // Init abp
        if (data) {
    ...
    prepareSplashScreen = () => {
      ...
      if (loaderType === "random") {
        let arrayTypes = Object.keys(splashScreens);
        let randomNumber = Math.floor(Math.random() * arrayTypes.length);
