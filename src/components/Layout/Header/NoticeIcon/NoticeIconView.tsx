...
class NoticeIconView extends Component<GlobalHeaderRightProps> {
  ...
  initNotification = async () => {
    ...
    this.setState({ unreadCount: noticeData.unreadCount, noticeData: { notifications: noticeData.notification || [] } })
  }
  ...
  getNoticeData = async () => {
    const result = await notificationService.getUserNotifications({ SkipCount: 0, MaxResultCount: 10 })
