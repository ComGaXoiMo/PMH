...
class PartnerService {
  public async create(body: any) {
    ...
    let res = await http.post('/api/services/app/Partners/CreatePartnerFull', body)
  ...
  public async delete(id: number) {
    let res = await http.delete('api/services/app/Partners/Delete', { params: { id } })
    return res.data
  }

  public async activateOrDeactivate(id: number, isActive) {
    let res = await http.post('api/services/app/Partners/Active', { id }, { params: { isActive } })
  ...
  public async get(id: number): Promise<any> {
    ...
    let res = await http.get('api/services/app/Partners/Get', { params: { id } })
    if (res.data.result && res.data.result.birthDate) {
      res.data.result.birthDate = moment(res.data.result.birthDate)
    }
    return res.data.result
  ...
  public async getProjectRoles(params: any): Promise<any> {
    let res = await http.get('api/services/app/Partners/GetProjectRoles', { params })
    return res.data.result
  }

  public async setProjectRole(body: any) {
    let res = await http.post('api/services/app/Partners/SetProjectRoles', body)
    return res.data.result
  }
