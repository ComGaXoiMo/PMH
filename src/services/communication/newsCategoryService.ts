...
class NewsCategoryService {
  public async create(body: Category) {
    let result = await http.post('/api/services/app/NewsCategories/Create', body)
    return result.data.result
  }

  public async update(body: any) {
    let result = await http.put('/api/services/app/NewsCategories/Update', body)
    return result.data.result
  }
  ...
  public async getAll(params: any): Promise<PagedResultDto<any>> {
    let result = await http.get('api/services/app/News/GetListNewsCategory', { params })
