...
const SLAReportFirstResponse = (props: Props) => {
  ...
  const getDashboard = async () => {
    ...
    const res = await wfStatusService.getEscalateDashboard({ Module: moduleId, target: 'FirstResponse' })
    setChartData(res)
    setLoading(false)
  }
  const createChart = () => {
  ...
  const handleExportFile = async () => {
    return await wfStatusService.exportEscalate({ Module: moduleId, target: 'FirstResponse', ...filter })
  }
