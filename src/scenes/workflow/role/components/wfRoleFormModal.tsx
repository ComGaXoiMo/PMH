        ...
        <Form ref={this.props.formRef} layout={'vertical'} validateMessages={validateMessages} size="large">
          <Row gutter={[16, 0]}>
            <Col sm={{ span: 24, offset: 0 }}>
              <FormInputMultiLanguage label="WF_ROLE_NAME" name="names" rule={rules.names} />
            </Col>
            <Col sm={{ span: 12, offset: 0 }}>
              <FormCheckbox label="WF_ROLE_IS_DEFAULT" name="isDefault" />
            </Col>
            <Col sm={{ span: 12, offset: 0 }}>
              <FormCheckbox label="WF_ROLE_IS_ACTIVE" name="isActive" />
            </Col>
            {!this.props.moduleId && (
              <Col sm={{ span: 24, offset: 0 }}>
                <FormSelect
