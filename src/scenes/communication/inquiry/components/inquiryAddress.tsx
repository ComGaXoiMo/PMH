import PlaceAutocompleteWithGoong from "@components/goongmapInput/PlaceAutocompleteWithGoong";
...
const InquiryAddressWithGoong = (props: Props) => {
  ...
  React.useEffect(() => {
    if (props.inquiryAddress) {
      setGeoCode([
        props.inquiryAddress.longitude,
        props.inquiryAddress.latitude,
      ]);

      setInitLabel(props.inquiryAddress.address);
      setDistrict([
        ...district,
        {
          id: props.inquiryAddress.districtId,
          name: props.inquiryAddress.districtName,
        },
      ]);
    }
  }, [props.inquiryAddress]);
...
export default InquiryAddressWithGoong;
