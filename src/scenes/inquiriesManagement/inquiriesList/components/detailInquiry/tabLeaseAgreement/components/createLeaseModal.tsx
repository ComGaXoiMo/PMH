    ...
    return (
      ...
      >
        ...
        >
          <Row gutter={[16, 8]}>
            <Col sm={{ span: 12 }}>
              <Form.Item label={L("LEASE_AGREEMENT_NAME")} name="">
                <Input placeholder={L("ENTER_INFOMATION")}></Input>
              </Form.Item>
            </Col>
            <Col sm={{ span: 12 }}>
              <Form.Item label={L("LEASE_AGREEMENT_STATUS")} name="">
                <Select placeholder={L("ENTER_INFOMATION")}></Select>
              </Form.Item>
            </Col>{" "}
            <Col sm={{ span: 24 }}>
              <Form.Item label={L("LEASE_AGREEMENT_OF_SUBMIT")} name="">
                <Input placeholder={L("ENTER_INFOMATION")}></Input>
              </Form.Item>
            </Col>{" "}
            <Col sm={{ span: 24 }}>
              <Form.Item label={L("LEASE_AGREEMENT_EXPIRATION")} name="">
                <Input placeholder={L("ENTER_INFOMATION")}></Input>
              </Form.Item>
            </Col>
            <Col sm={{ span: 24 }}>
              <Form.Item label={L("LEASE_AGREEMENT_ATTACHMENT")} name="">
                <Input placeholder={L("ENTER_INFOMATION")}></Input>
              </Form.Item>
            </Col>
            <Col sm={{ span: 24 }}>
